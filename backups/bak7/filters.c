...
{
    // il facem double pt ca sa avem cat mai mare precizie
    double kernel[KERNEL_SIZE][KERNEL_SIZE];
    Filters_InitKernel(kernel, filter, filterType);
    // stim sigur ca este poza RGB
    PixelRGB_t **pixelsRGB  = (PixelRGB_t**) image->pixels;
    // aplicam kernelul curent pe portiunea de imagine admisa
...
{
    // initializez structura statica filtre cu toate filtrele necesare si coeficientii de normalizare
